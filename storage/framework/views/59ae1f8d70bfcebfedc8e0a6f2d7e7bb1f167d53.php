        ...
        <div class="card shadow">
            <div class="card-header bg-gray py-3">
                ...
                <div class="card-header-tab card-header">
                    ...
                    <form method="POST" action="<?php echo e(route ('tambah.kuisioner')); ?>" enctype="multipart/form-data">
                    <div class="card-body">
                        <?php echo csrf_field(); ?>
                        <!-- start soal -->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/rioanugrahputra/Absensi-Perpustakaan/resources/views/surveikepuasan.blade.php ENDPATH**/ ?>
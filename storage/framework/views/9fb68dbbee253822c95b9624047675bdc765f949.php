...
<div class="container-fluid"><a class="btn btn-link link-primary mb-3" role="button" href="<?php echo e(url('management')); ?>"><i class="fas fa-arrow-left"></i> Back</a>
        ...
        <div class="card shadow mb-3">
            ...
            <div class="card-body">
                <div class="container-fluid d-flex align-items-center justify-content-center flex-column py-4 mb-4 border rounded">
                    <img id="output" src="<?php echo e($user->image ?? asset('assets/img/user-profile-icon-front-side_kljtj0.jpg')); ?>" class="rounded-circle mb-3 mt-4 img-fluid border object-fit-none" width="110px" height="110px" style="display: inline;height: 110px; width: 110px"/>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-8 col-lg-8">
                        <div class="mb-3"><label class="form-label" for="name"><strong>Nama Lengkap *</strong></label><input id="name" class="form-control" type="text" placeholder="<?php echo e($user->name); ?>" name="name" value="<?php echo e($user->name); ?>" required /></div>
                    </div>
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="mb-3"><label class="form-label" for="NIM/NIPPK/No.Telp"><strong>Email *</strong><br /></label><input id="NIM/NIPPK/No.Telp" class="form-control" type="text" placeholder="<?php echo e($user->email); ?>" value="<?php echo e($user->email); ?>" name="email" required /></div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="mb-3"><label class="form-label" for="country"><strong>Prodi *</strong></label><select class="form-select countries order-alpha limit-pop-1000000 presel-MX group-continents group-order-na" name="prodi" required>
                            <option value="<?php echo e($user->prodi); ?>"><?php echo e($user->prodi); ?></option>
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="mb-3"><label class="form-label" for="address"><strong>Alamat *</strong><br /></label><input id="alamat" class="form-control" type="text" placeholder="<?php echo e($user->alamat); ?>" name="alamat" required /></div>
                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/rioanugrahputra/Absensi-Perpustakaan/resources/views/admin/kelolaUser/edit.blade.php ENDPATH**/ ?>
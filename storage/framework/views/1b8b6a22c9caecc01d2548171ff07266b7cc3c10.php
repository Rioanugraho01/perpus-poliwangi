...
<section>
    <div class="container">
        <div class="row gx-1 gx-lg-2 row-cols-3 row-cols-xl-3 justify-content-center">
            <?php $__currentLoopData = $topUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pengunjung): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col">
                <div class="card shadow-lg rounded">
                    <img class="border-0" src="<?php echo e($pengunjung->users->image ?? asset('assets/img/user-profile-icon-front-side_kljtj0.jpg')); ?>" alt="Responsive Image" /></p>
                    <div class="card-body">
                        <div class="text-center">
                            <h6><?php echo e($pengunjung->users->name); ?></h6>
                            <p><?php echo e($pengunjung->users->status); ?></p>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="container py-4 py-xl-5">
        <div class="row">
            <div class="col-md-6">
                <i class="fa fa-user" ></i><span> <?php echo e(Auth::user()->status ?? 'User'); ?></span>
                <h3 class="display-6 fw-bold pb-md-4">Hallo&nbsp;<span class="underline" style="color: var(--bs-indigo);"><?php echo e(Auth::user()->name ?? 'Selamat Datang'); ?></span></h3>
    ...
    <div class="container py-4 py-xl-5">
        <div class="row gy-4 gy-md-0">
            <div class="col-md-6 text-center text-md-start d-flex d-sm-flex d-md-flex justify-content-center align-items-center justify-content-md-start align-items-md-center justify-content-xl-center">
                <div><img class="rounded img-fluid fit-cover" style="min-height: 300px;" src="<?php echo e(asset('bootstrap/img/illustrations/presentation.svg')); ?>" width="800"></div>
            </div>
            <div class="col">
                ...
                </div><a class="btn btn-warning me-2 mt-2" role="button" href="<?php echo e(url('surveikepuasan')); ?>" style="background: var(--bs-indigo);color: var(--bs-white);display: inline-block;border-style: none;">Lihat Selengkapnya</a>
            </div>
        </div>
    </div>
</section>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/rioanugrahputra/Absensi-Perpustakaan/resources/views/welcome.blade.php ENDPATH**/ ?>
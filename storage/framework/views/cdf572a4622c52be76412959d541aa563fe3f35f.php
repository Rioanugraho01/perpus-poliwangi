      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <form method="post" action="<?php echo e(url('post')); ?>">
            ...
            <input type="text" name="name" class="form-control mt-1" required readonly value="<?php echo e(Auth::user()->name); ?>">
            ...
            <input type="text" name="email" class="form-control mt-1" required readonly id="email" value="<?php echo e(Auth::user()->email); ?>">
            <label class="mt-4"><b>status *</b></label>
            <input type="text" name="status" class="form-control mt-1" required readonly id="email" value="<?php echo e(Auth::user()->status); ?>">
            ...
            <select class="form-select countries order-alpha limit-pop-1000000 presel-MX group-continents group-order-na" name="prodi" readonly required>
                <option value="<?php echo e(Auth::user()->prodi); ?>"><?php echo e(Auth::user()->prodi); ?></option>
              </select></div>
            <div class="py-4">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/rioanugrahputra/Absensi-Perpustakaan/resources/views/geolokasi.blade.php ENDPATH**/ ?>
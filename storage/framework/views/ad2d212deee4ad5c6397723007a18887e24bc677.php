        ...
        <div class="row d-flex align-items-start flex-wrap">
            ...
            <div class="col-lg-5 col-xl-4 mb-4">
                ...
                <div class="row">
                    ...
                    <?php $__currentLoopData = $coordinat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coordinat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="row mb-3">
                        <div class="mb-3">
                            <input id="myInput" value="<?php echo e($coordinat->koordinat1); ?>" class="form-control" type="text" placeholder="Koordinat 1" name="koordinat1" />
                        </div>
                        <div class="mb-3">
                            <input readonly value="<?php echo e($coordinat->koordinat2); ?>" class="form-control" type="text" placeholder="Koordinat 2" name="koordinat2" />
                        </div>
                        <div class="mb-3">
                            <input readonly value="<?php echo e($coordinat->koordinat3); ?>" class="form-control" type="text" placeholder="Koordinat 3" name="koordinat3" />
                        </div>
                        <div class="mb-3">
                            <input readonly value="<?php echo e($coordinat->koordinat4); ?>" class="form-control" type="text" placeholder="Koordinat 4" name="koordinat 4" />
                        </div>
                        <div class="mb-3">
                            <form method="post" action="<?php echo e(route('geolocation',$coordinat->id)); ?>">
                                <?php echo csrf_field(); ?>
                    ...
                    <hr>
                    <form method="post" action="<?php echo e(url('geolocation/post')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/rioanugrahputra/Absensi-Perpustakaan/resources/views/geolocation.blade.php ENDPATH**/ ?>
        ...
        <div class="card-header border py-3" style="border-top-left-radius: 30px; border-top-right-radius: 30px;">
            <div class="row align-items-center p-2">
                <div class="col-md-6 py-2">
                    <a href="<?php echo e(route('user.create')); ?>" class="btn btn-primary" type="button" style="font-size: 12px; heigh:40px;">
                ...
                <table id="data-table" class="table my-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img class="rounded-circle me-2" width="30" height="30" src="<?php echo e($user->image ?? asset('assets/img/user-profile-icon-front-side_kljtj0.jpg')); ?>" /></td>
                            <td><?php echo e($user->name); ?></td>
                            <td><?php echo e($user->email); ?></td>
                            <td><?php echo e($user->prodi); ?></td>
                            <td><?php echo e($user->status); ?></td>
                            <td><?php echo e($user->alamat); ?></td>
                            <td style="width: 60px;"><form action="<?php echo e(route('user.destroy',$user->id)); ?>" method="post">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/rioanugrahputra/Absensi-Perpustakaan/resources/views/admin/management.blade.php ENDPATH**/ ?>
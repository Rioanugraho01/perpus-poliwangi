        ...
        <div class="row gx-3 gx-lg-2 row-cols-2 row-cols-xl-3">
            ...
            <div class="col">
                <div class="card shadow-lg rounded">
                    ...
                    <div class="text-center">
                        <a class="stretched-link" style="border-radius: 5px;" href="<?php echo e(url('geolokasi')); ?>"></a>
                    </div>
                </div>
            </div>
            <div class="col mt-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/rioanugrahputra/Absensi-Perpustakaan/resources/views/presensi.blade.php ENDPATH**/ ?>
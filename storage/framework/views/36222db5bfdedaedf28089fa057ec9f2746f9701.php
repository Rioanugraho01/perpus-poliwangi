...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('owl/css/docs.theme.min.css')); ?>">
    ...
    <script src="<?php echo e(asset('owl/js/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(asset('owl/js/owl.carousel.js')); ?>"></script>
...
<body>
        ...
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="https://ta.poliwangi.ac.id/~ti21003/"><span class="desktop" style="text-align: center;">Perpustakaan <br>Poliwangi</span><span class="mobile">Perpustakaan Poliwangi</span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item desktop"><a class="nav-link <?php echo e((Request::is('/') ? 'active' : '')); ?>" href="<?php echo e(url('/')); ?>" style="text-align: center;">Halaman<br>Utama</a></li>
                    <li class="nav-item desktop"><a class="nav-link <?php echo e((Request::is('history') ? 'active' : '')); ?>" href="<?php echo e(url('history')); ?>" style="text-align: center;">History <br>Kunjungan</a></li>
                    

                    <li class="nav-item mobile"><a class="nav-link mb-1 <?php echo e((Request::is('/') ? 'active' : '')); ?>" href="<?php echo e(url('/')); ?>">Halaman Utama</a></li>
                    <li class="nav-item mobile"><a class="nav-link mb-1 <?php echo e((Request::is('historykunjungan') ? 'active' : '')); ?>" href="<?php echo e(url('historykunjungan')); ?>">History Kunjungan</a></li>
                    
                </ul>
                <ul class="navbar-nav">
                    <?php if(auth()->guard()->guest()): ?>
                    <?php if(Route::has('login')): ?>
                    <a class="btn btn-primary shadow" role="button" href="<?php echo e(route('login')); ?>">Masuk</a>
                    <?php endif; ?>
                    <?php else: ?>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-danger" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item bg-danger text-white" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
    ...
    <nav class="navbar fixed-bottom bottom-bars shadow-lg mobile">
        <ion-icon id="home" name="home-outline" class="icons <?php echo e((Request::is('/') ? 'actives' : '')); ?>" onclick="change(this); return welcome();">
        </ion-icon>
        <ion-icon id="presensi" name="reader-outline" class="icons <?php echo e((Request::is('presensi') ? 'actives' : '')); ?>" onclick="change(this); return presensi();">
        </ion-icon>
        <ion-icon id="history" name="list-circle-outline" class="icons <?php echo e((Request::is('history') ? 'actives' : '')); ?>" onclick="change(this); return historykunjungan();">
        </ion-icon>
        <ion-icon id="profile" name="person-outline" class="icons <?php echo e((Request::is('profile') ? 'actives' : '')); ?>" onclick="change(this); return profile();">
        </ion-icon></div>
    </nav>
    ...
    <script src="<?php echo e(asset('bootstrap/js/startup-modern.js')); ?>"></script>
    <script src="<?php echo e(asset('owl/js/highlight.js')); ?>"></script>
    <script src="<?php echo e(asset('owl/js/app.js')); ?>"></script>
    <script>
        ...
        $("#presensi").on('click', function() {
            window.location.href = "<?php echo e(url('presensi')); ?>";
        });
        $("#history").on('click', function() {
            window.location = "<?php echo e(url('history')); ?>";
        });
        $("#profile").on('click', function() {
            window.location = "<?php echo e(url('profile')); ?>";
        });
    </script>
    <script>
...
<?php /**PATH /Users/rioanugrahputra/Absensi-Perpustakaan/resources/views/layouts/app.blade.php ENDPATH**/ ?>